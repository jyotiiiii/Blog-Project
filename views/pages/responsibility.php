        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <p class="card-text mb-auto">Please think carefully about your contributions and take every measure to ensure your words do not cause offence.</p>
            </div>
              <img class="card-img-right flex-auto d-none d-lg-block" href="https://imgur.com/yAe0edI"><img src="https://i.imgur.com/yAe0edI.png" title="source: imgur.com" style="width: 170px; height: 140px;"/></a>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <p class="card-text mb-auto">Our mission is to keep working</p>
            </div>
              <img class="card-img-right flex-auto d-none d-lg-block" href="https://imgur.com/yAe0edI"><img src="https://i.imgur.com/yAe0edI.png" title="source: imgur.com" style="width: 170px; height: 140px;" /></a>
