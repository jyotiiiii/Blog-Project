            ...
            <div class="card-body d-flex flex-column align-items-start">
                <img class="card-img-top text-center" src="https://i.imgur.com/5LVRHtR.png" alt="Card image cap">
                    <strong class="d-inline-block mb-2 text-black">Gabriella</strong>
                     <h3 class="mb-0">
                    <a class="text-dark" href="#">Literature</a>
                </h3>
                <div class="mb-1 text-muted">ID:</div>
                    <div
        ...
        <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
                <img class="card-img-top text-center" src="https://i.imgur.com/5LVRHtR.png" alt="Card image cap">
                        ...
                        <h3 class="mb-0">
                    <a class="text-dark" href="#">Lifestyle</a>
                </h3>
                <div class="mb-1 text-muted">ID:</div>
                        <div
                            <p class="card-text mb-auto">Hi. I’m Niki, and I welcome you in this corner of the internet where I share the practical methods I have developed in the past few years to create a life that I like living without compromising my introvert self.</p>
                            <a class="text-light bg-dark" href="#">Lifestyle Blogs</a>
                        </div>
            ...
            <div class="card-body d-flex flex-column align-items-start">
                <img class="card-img-top text-center" src="https://i.imgur.com/5LVRHtR.png" alt="Card image cap">
                            <strong class="d-inline-block mb-2 text-black">Jyoti</strong>
                             <h3 class="mb-0">
                    <a class="text-dark" href="#">Making</a>
                </h3>
                <div class="mb-1 text-muted">ID:</div>
                            <div
            ...
            <div class="card-body d-flex flex-column align-items-start">
                <img class="card-img-top text-center" src="https://i.imgur.com/5LVRHtR.png" alt="Card image cap">
                                <strong class="d-inline-block mb-2 text-black">Omo</strong>
                                 <h3 class="mb-0">
                    <a class="text-dark" href="#">Performance</a>
                </h3>
                <div class="mb-1 text-muted">ID:</div>
                                <div
