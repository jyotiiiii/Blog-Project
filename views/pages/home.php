         ...
         <!-- <h1 class="display-4 font-italic">Title of a longer featured blog post</h1>
          ...
          <p class="lead mb-0"><a href="#" class="text-white font-weight-bold">Continue reading...</a></p>-->
           <div class="social-icons clearfix"> 
             ...
             <a href="index.php" onMouseOver="document.MyImage.src='https://i.imgur.com/QN3DDtC.png';" onMouseOut="document.MyImage.src='https://i.imgur.com/5LVRHtR.png';">
	<img src="https://i.imgur.com/5LVRHtR.png" name="MyImage" height="173px" width="150px">
      ...
      <div class="row mb-2">
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-black">Cooking</strong>
              <h3 class="mb-0">
                <a class="text-dark" href="#">Post title</a>
              </h3>
              <div class="mb-1 text-muted">Date</div>
              ...
              <img class="card-img-right flex-auto d-none d-lg-block" href="https://imgur.com/y6xQD2v"><img src="https://i.imgur.com/y6xQD2v.png" title="source: imgur.com" style="width: 370px; height: 370px;" /></a>
      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-black">Printing</strong>
              <h3 class="mb-0">
                <a class="text-dark" href="#">Post title</a>
              </h3>
              <div class="mb-1 text-muted">Date</div>
