        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-black">Category</strong>
              <h3 class="mb-0">
              ...
              <img class="card-img-right flex-auto d-none d-lg-block" href="https://imgur.com/RWhW18q"><img src="https://i.imgur.com/38DyfOO.png" title="source: imgur.com" style="width: 370px; height: 370px;"/></a>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <div class="mb-1 text-muted">Date</div>
              <p class="card-text mb-auto">This is where the leading goes.</p>
              <a class="text-dark" href="#">View Blog</a>
            </div>
