        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <img class="card-img-right flex-auto d-none d-lg-block"><img src="../images/Fashion1.jpeg"  title="source:najwa" style="width: 370px; height: 370px;"/></a>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-370">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <img class="card-img-right flex-auto d-none d-lg-block"><img src="../images/Fashion2.jpeg" title="source:najwa" style="width: 370px; height: 370px;" /></a>
