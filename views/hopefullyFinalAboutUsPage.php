...
<html>
    ...
    <header class="white_bg text-center py-5 mb-4">
        <div class="container">
            <h1 class="font-weight-light text-pink">About Us</h1>
        </div>
    </header>
        <link href="https://fonts.googleapis.com/css?family=Asap|Pacifico" rel="stylesheet">
